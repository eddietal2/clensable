  ...
  <div class="max-w-md w-full bg-white p-8 rounded-lg shadow-lg">
    ...
    {#if !loginSuccess}
      ...
      {#if message && !loginSuccess}
        <p class="mt-4 p-2 text-center font-medium {messageError ? 'text-white bg-red-700' : 'text-white bg-green-700'} rounded transition">
          {message}
        </p>
      {/if}
    ...
    {:else}
      ...
      <div class="text-center py-12">
        <svg class="h-16 mx-auto" version="1.1" id="_x36_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"  xml:space="preserve">
          <g>
    ...
    {#if !loginSuccess}
      <p class="mt-6 text-center text-sm text-gray-600">
        ...
        <a href="/sign-up" class="text-green-600 hover:text-green-800 font-medium">Sign up</a>
      </p>
    {/if}
